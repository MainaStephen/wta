...
//   return (
//     <header className="bg-white shadow-thin sticky top-0 z-50">

//       {/* Main Header */}
//       <div className="max-w-7xl mx-auto px-4 flex items-center justify-between h-20 md:h-[106px]">
//         {/* Logo */}
...
//             width={160}
//             height={65}
//             className="h-16 md:h-[65px] w-auto"
//           />
//         </Link>
...
//           <Link
//             href="/about-us"
//             className="px-4 py-2 text-gray-700 font-bold hover:text-[#E1251B] transition"
//           >
//             Our Conferences
//           </Link>
//           <Link
...
//             className="bg-[#E1251B] text-white px-5 py-2.5 rounded-[1em_0] font-semibold text-sm hover:bg-transparent hover:text-[#E1251B] hover:border hover:border-[#E1251B] transition"
//           >
...
//           <Link
//             href="/about-us"
//             className="text-gray-700 font-bold hover:text-[#E1251B] transition"
//           >
//             Our Conferences
//           </Link>
//           <Link
...
//           <Link
//             href="https://docs.google.com/forms/d/e/1FAIpQLSesFn7D1B1K3ngmz007QvpdYt_4H-kr2NHw5GeixArcjGfZ8g/viewform"
//             className="bg-[#E1251B] text-white px-5 py-2.5 rounded-[1em_0] font-semibold text-center"
//           >
//             2026 Conference Registration
//           </Link>
//         </div>
